...
# Selects a group of files inform filename
def readGroupOfFilesAndFilename(datasets_path):
    ...
    return categoriesName, outputFileName

# Selects a group of files
# inform filename, title and subtitle
def readGroupOfFilesAndTitles(datasets_path):
